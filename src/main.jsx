    ...
    <main>
      ...
      <section id="top" className="hero section">
        ...
        <div className="dashboardShell" aria-label="Meow product dashboard concept preview">
          <img className="heroGlobe" src="/meow-assets/hero-globe.svg" alt="Global finance globe illustration from Meow" />
      ...
      <section className="credibilityStrip" aria-label="Company credibility logos">
        ...
        <div className="logoStack">
          {companyLogos.map((src, index) => (
            <span className="logoTile" key={src}>
              <img src={src} alt={`Meow customer or partner logo ${index + 1}`} loading="lazy" />
            </span>
          ))}
        </div>
      </section>
